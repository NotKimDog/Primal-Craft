    ...
    protected RecipeGenerator getRecipeGenerator(RegistryWrapper.WrapperLookup wrapperLookup, RecipeExporter recipeExporter) {
        return new RecipeGenerator(wrapperLookup, recipeExporter) {
            ...
            public void generate() {
                ...
                TutorialMod.LOGGER.info("║  STARTING RECIPE GENERATION                                ║");
                TutorialMod.LOGGER.info("╚════════════════════════════════════════════════════════════╝");
                ...
                TutorialMod.LOGGER.info("  ✓ Smelting recipes: {} recipes", smeltingRecipes);
                TutorialMod.LOGGER.info("  ✓ Blasting recipes: {} recipes", blastingRecipes);
                ...
                TutorialMod.LOGGER.debug("  • Detected {} stick variants", allSticks.size());
                ...
                TutorialMod.LOGGER.info("  ✓ Tool recipes: {} recipes (swords: {}, hammers: {}, shovels: {}, axes: {}, hoes: {})",
                ...
                TutorialMod.LOGGER.info("  ✓ Armor recipes: {} recipes (helmets: {}, chestplates: {}, leggings: {}, boots: {})",
                ...
                TutorialMod.LOGGER.info("  ✓ Custom recipes: {} recipes (shaped: {}, shapeless: {})",
                ...
                TutorialMod.LOGGER.debug("  • Added compacting recipes");
                ...
                TutorialMod.LOGGER.debug("  • Added smithing trim recipes");

                long elapsed = System.currentTimeMillis() - startTime;
                int totalRecipes = smeltingRecipes + blastingRecipes + toolRecipes + armorRecipes + customCount + 2;
                TutorialMod.LOGGER.info("╔════════════════════════════════════════════════════════════╗");
                TutorialMod.LOGGER.info("║  RECIPE GENERATION COMPLETE                                ║");
                TutorialMod.LOGGER.info("╚════════════════════════════════════════════════════════════╝");
                TutorialMod.LOGGER.info("  📊 Total Recipes Generated: {}", totalRecipes);
