...
public class ModModelProvider extends FabricModelProvider {
    ...
    public void generateBlockStateModels(BlockStateModelGenerator blockStateModelGenerator) {
        ...
        TutorialMod.LOGGER.info("║  STARTING BLOCKSTATE & MODEL GENERATION                    ║");
        TutorialMod.LOGGER.info("╚════════════════════════════════════════════════════════════╝");
        ...
        TutorialMod.LOGGER.debug("  ✓ Generated {} ore/base block models", 6);
        ...
        TutorialMod.LOGGER.debug("  ✓ Generated {} variant models (stairs, slab, etc.)", 7);
        ...
        TutorialMod.LOGGER.debug("  ✓ Generated door & trapdoor models");
        ...
        blocksGenerated++;
        TutorialMod.LOGGER.debug("  ✓ Generated lamp variants (on/off)");
        ...
        blocksGenerated++;
        TutorialMod.LOGGER.debug("  ✓ Generated crop model (7 stages)");
        ...
        blocksGenerated++;
        TutorialMod.LOGGER.debug("  ✓ Generated berry bush model (4 stages)");
        ...
        blocksGenerated += 2;
        TutorialMod.LOGGER.debug("  ✓ Generated log & wood models (4 variants)");
        ...
        blocksGenerated++;
        TutorialMod.LOGGER.debug("  ✓ Generated wood block models (planks, leaves, sapling)");
        ...
        blocksGenerated++;
        TutorialMod.LOGGER.debug("  ✓ Generated furniture models");

        long elapsed = System.currentTimeMillis() - startTime;
        TutorialMod.LOGGER.info("  📊 Block Models Generated: {}", blocksGenerated);
    ...
    public void generateItemModels(ItemModelGenerator itemModelGenerator) {
        long startTime = System.currentTimeMillis();
        TutorialMod.LOGGER.info("╔════════════════════════════════════════════════════════════╗");
        TutorialMod.LOGGER.info("║  STARTING ITEM MODEL GENERATION                            ║");
        TutorialMod.LOGGER.info("╚════════════════════════════════════════════════════════════╝");
        ...
        itemsGenerated += 2;
        TutorialMod.LOGGER.debug("  • Generated material item models");

        itemModelGenerator.register(ModItems.CAULIFLOWER, Models.GENERATED);
        itemModelGenerator.register(ModItems.STARLIGHT_ASHES, Models.GENERATED);
        itemsGenerated += 2;
        TutorialMod.LOGGER.debug("  • Generated crop item models");
        ...
        itemsGenerated += 10;
        TutorialMod.LOGGER.debug("  • Generated 10 stick variants");
        ...
        itemsGenerated += 4;
        TutorialMod.LOGGER.debug("  • Generated 4 armor piece models with trim support");
        ...
        itemsGenerated += 4;
        TutorialMod.LOGGER.debug("  • Generated decorative/special item models");

        itemModelGenerator.register(ModItems.MANTIS_SPAWN_EGG,
                new Model(Optional.of(Identifier.of("item/template_spawn_egg")), Optional.empty()));
        itemsGenerated++;
        TutorialMod.LOGGER.debug("  • Generated spawn egg model");
        ...
        itemsGenerated++;
        TutorialMod.LOGGER.debug("  • Generated conditional item models (chisel variants)");

        long elapsed = System.currentTimeMillis() - startTime;
        TutorialMod.LOGGER.info("  📊 Item Models Generated: {}", itemsGenerated);
        TutorialMod.LOGGER.info("  ⏱️  Execution Time: {}ms", elapsed);
    }
}