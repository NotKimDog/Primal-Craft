...
public class ModBlockTagProvider extends FabricTagProvider.BlockTagProvider {
    ...
    protected void configure(RegistryWrapper.WrapperLookup wrapperLookup) {
        ...
        PrimalCraft.LOGGER.info("║  STARTING BLOCK TAG GENERATION                             ║");
        PrimalCraft.LOGGER.info("╚════════════════════════════════════════════════════════════╝");
        ...
        PrimalCraft.LOGGER.debug("  • Added {} ore blocks to pickaxe mineable", DatagenHelper.getOres().size());
        ...
        PrimalCraft.LOGGER.debug("  • Added {} additional blocks to pickaxe mineable", pickaxeExtra.size());

        PrimalCraft.LOGGER.info("  ✓ Pickaxe mineable blocks: {} total", pickaxeCount);
        tagsCreated++;
        ...
        PrimalCraft.LOGGER.info("  ✓ Axe mineable blocks: {} total", axeCount);
        tagsCreated++;
        ...
        PrimalCraft.LOGGER.info("  ✓ Iron tool required blocks: {}", ironBlocks.size());
        tagsCreated++;
        ...
        PrimalCraft.LOGGER.info("  ✓ Diamond tool required blocks: {}", diamondBlocks.size());
        tagsCreated++;
        ...
        PrimalCraft.LOGGER.info("  ✓ Fences: {} blocks", fenceBlocks.size());
        tagsCreated++;
        ...
        PrimalCraft.LOGGER.info("  ✓ Fence gates: {} blocks", gateBlocks.size());
        tagsCreated++;
        ...
        PrimalCraft.LOGGER.info("  ✓ Walls: {} blocks", wallBlocks.size());
        tagsCreated++;
        ...
        PrimalCraft.LOGGER.info("  ✓ Logs that burn: {} blocks", logBlocks.size());
        tagsCreated++;
        ...
        PrimalCraft.LOGGER.info("  ✓ Pink Garnet tool required blocks: {}", customBlocks.size());
        tagsCreated++;

        long elapsed = System.currentTimeMillis() - startTime;
        PrimalCraft.LOGGER.info("╔════════════════════════════════════════════════════════════╗");
        PrimalCraft.LOGGER.info("║  BLOCK TAG GENERATION COMPLETE                             ║");
        PrimalCraft.LOGGER.info("╚════════════════════════════════════════════════════════════╝");
        PrimalCraft.LOGGER.info("  📊 Total Tags Created: {}", tagsCreated);
