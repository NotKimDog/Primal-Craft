...
public class ModLootTableProvider extends FabricBlockLootTableProvider {
    ...
    public void generate() {
        ...
        PrimalCraft.LOGGER.info("║  STARTING LOOT TABLE GENERATION                            ║");
        PrimalCraft.LOGGER.info("╚════════════════════════════════════════════════════════════╝");
        ...
        PrimalCraft.LOGGER.debug("🔍 Processing {} blocks for loot table generation...", DatagenHelper.getAllBlocks().size());
        ...
        PrimalCraft.LOGGER.info("╔════════════════════════════════════════════════════════════╗");
        PrimalCraft.LOGGER.info("║  LOOT TABLE GENERATION COMPLETE                            ║");
        PrimalCraft.LOGGER.info("╚════════════════════════════════════════════════════════════╝");
        PrimalCraft.LOGGER.info("  📊 Loot Table Breakdown:");
        PrimalCraft.LOGGER.info("     • Ores: {} tables", ores);
        PrimalCraft.LOGGER.info("     • Slabs: {} tables", slabs);
        PrimalCraft.LOGGER.info("     • Doors: {} tables", doors);
        PrimalCraft.LOGGER.info("     • Leaves: {} tables", leaves);
        PrimalCraft.LOGGER.info("     • Crops: {} tables", crops);
        PrimalCraft.LOGGER.info("     • Berry Bushes: {} tables", bushes);
        PrimalCraft.LOGGER.info("     • Regular Blocks: {} tables", regular);
        PrimalCraft.LOGGER.info("  ✓ Generated {} loot tables automatically", generated);
