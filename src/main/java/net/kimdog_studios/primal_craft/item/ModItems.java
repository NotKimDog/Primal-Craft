...
import net.kimdog_studios.primal_craft.item.custom.ChiselItem;
import net.kimdog_studios.primal_craft.item.custom.HammerItem;
import net.kimdog_studios.primal_craft.item.custom.ModArmorItem;
import net.kimdog_studios.primal_craft.item.custom.TomahawkItem;
...
public class ModItems {
    ...
    public static final Item CAULIFLOWER = registerItem("cauliflower", setting -> new Item(setting
        ...
        public void appendTooltip(ItemStack stack, Item.TooltipContext context, TooltipDisplayComponent displayComponent, Consumer<Text> textConsumer, TooltipType type) {
            textConsumer.accept(Text.translatable("tooltip.primal-craft.cauliflower.tooltip"));
    ...
    private static Item registerItem(String name, Function<Item.Settings, Item> function) {
        return Registry.register(Registries.ITEM, Identifier.of(PrimalCraft.MOD_ID, name),
                function.apply(new Item.Settings().registryKey(RegistryKey.of(RegistryKeys.ITEM, Identifier.of(PrimalCraft.MOD_ID, name)))));
    }


    public static void registerModItems() {
        PrimalCraft.LOGGER.info("Registering Mod Items for " + PrimalCraft.MOD_ID);
