package net.kimdog_studios.primal_craft.entity;

import net.kimdog_studios.primal_craft.PrimalCraft;
import net.kimdog_studios.primal_craft.entity.custom.ChairEntity;
import net.kimdog_studios.primal_craft.entity.custom.MantisEntity;
import net.kimdog_studios.primal_craft.entity.custom.TomahawkProjectileEntity;
...
public class ModEntities {
    private static final RegistryKey<EntityType<?>> MANTIS_KEY =
            RegistryKey.of(RegistryKeys.ENTITY_TYPE, Identifier.of(PrimalCraft.MOD_ID, "mantis"));
    private static final RegistryKey<EntityType<?>> TOMAHAWK_KEY =
            RegistryKey.of(RegistryKeys.ENTITY_TYPE, Identifier.of(PrimalCraft.MOD_ID, "tomahawk"));
    private static final RegistryKey<EntityType<?>> CHAIR_KEY =
            RegistryKey.of(RegistryKeys.ENTITY_TYPE, Identifier.of(PrimalCraft.MOD_ID, "chair_entity"));


    public static final EntityType<MantisEntity> MANTIS = Registry.register(Registries.ENTITY_TYPE,
            Identifier.of(PrimalCraft.MOD_ID, "mantis"),
    ...
    public static final EntityType<TomahawkProjectileEntity> TOMAHAWK = Registry.register(Registries.ENTITY_TYPE,
            Identifier.of(PrimalCraft.MOD_ID, "tomahawk"),
    ...
    public static final EntityType<ChairEntity> CHAIR = Registry.register(Registries.ENTITY_TYPE,
            Identifier.of(PrimalCraft.MOD_ID, "chair_entity"),
    ...
    public static void registerModEntities() {
        PrimalCraft.LOGGER.info("Registering Mod Entities for " + PrimalCraft.MOD_ID);
    }
}
