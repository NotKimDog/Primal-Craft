package net.kimdog_studios.primal_craft.villager;
...
public class ModVillagers {
    ...
    public static final RegistryKey<VillagerProfession> KAPUENGER_KEY =
            RegistryKey.of(RegistryKeys.VILLAGER_PROFESSION, Identifier.of(PrimalCraft.MOD_ID, "kaupenger"));
    public static final VillagerProfession KAUPENGER = registerProfession("kaupenger", KAUPEN_POI_KEY);
    

    private static VillagerProfession registerProfession(String name, RegistryKey<PointOfInterestType> type) {
        return Registry.register(Registries.VILLAGER_PROFESSION, Identifier.of(PrimalCraft.MOD_ID, name),
    ...
    private static PointOfInterestType registerPOI(String name, Block block) {
        return PointOfInterestHelper.register(Identifier.of(PrimalCraft.MOD_ID, name),
                1, 1, block);
    }

    private static RegistryKey<PointOfInterestType> registerPoiKey(String name) {
        return RegistryKey.of(RegistryKeys.POINT_OF_INTEREST_TYPE, Identifier.of(PrimalCraft.MOD_ID, name));
    }

    public static void registerVillagers() {
        PrimalCraft.LOGGER.info("Registering Villagers for " + PrimalCraft.MOD_ID);
    }
}
