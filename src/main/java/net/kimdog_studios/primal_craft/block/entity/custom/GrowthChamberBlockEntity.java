package net.kimdog_studios.primal_craft.block.entity.custom;

import net.fabricmc.fabric.api.screenhandler.v1.ExtendedScreenHandlerFactory;
import net.kimdog_studios.primal_craft.block.entity.ImplementedInventory;
import net.kimdog_studios.primal_craft.block.entity.ModBlockEntities;
import net.kimdog_studios.primal_craft.item.ModItems;
import net.kimdog_studios.primal_craft.recipe.GrowthChamberRecipe;
import net.kimdog_studios.primal_craft.recipe.GrowthChamberRecipeInput;
...
public class GrowthChamberBlockEntity extends BlockEntity implements ExtendedScreenHandlerFactory<BlockPos>, ImplementedInventory {
    ...
    public Text getDisplayName() {
        return Text.translatable("block.primal-craft.growth_chamber");
    }
