package net.kimdog_studios.primal_craft.block;

import net.fabricmc.fabric.api.itemgroup.v1.ItemGroupEvents;
import net.kimdog_studios.primal_craft.PrimalCraft;
import net.kimdog_studios.primal_craft.block.custom.*;
import net.kimdog_studios.primal_craft.sound.ModSounds;
import net.kimdog_studios.primal_craft.world.tree.ModSaplingGenerators;
...
public class ModBlocks {
    ...
    // -------------------------
    // Building Blocks: stairs/slabs/plates/buttons/fences/walls
    // -------------------------
    ...
    public static final Block PINK_GARNET_FENCE_GATE = registerBlock("pink_garnet_fence_gate",
            properties -> new FenceGateBlock(WoodType.OAK, properties.strength(2f).requiresTool()));
    ...
    // Doors / Trapdoors
    // -------------------------
    // Use a wood BlockSetType (OAK) so the door and trapdoor can be opened by hand.
    public static final Block PINK_GARNET_DOOR = registerBlock("pink_garnet_door",
            properties -> new DoorBlock(BlockSetType.OAK, properties.strength(2f).requiresTool().nonOpaque()));

    public static final Block PINK_GARNET_TRAPDOOR = registerBlock("pink_garnet_trapdoor",
            properties -> new TrapdoorBlock(BlockSetType.OAK, properties.strength(2f).requiresTool().nonOpaque()));

    // -------------------------
    // Crafting Tables (various wood types)
    // -------------------------
    public static final Block ACACIA_CRAFTING_TABLE = registerBlock("acacia_crafting_table",
            properties -> new CraftingTableBlock(properties.strength(0.5f).sounds(BlockSoundGroup.WOOD)));
    ...
    public static final Block MANGROVE_CRAFTING_TABLE = registerBlock("mangrove_crafting_table",
            properties -> new CraftingTableBlock(properties.strength(0.5f).sounds(BlockSoundGroup.WOOD)));
    public static final Block PALEOAK_CRAFTING_TABLE = registerBlock("pale_oak_crafting_table",
            properties -> new CraftingTableBlock(properties.strength(0.5f).sounds(BlockSoundGroup.WOOD)));
    ...
    private static Block registerBlock(String name, Function<AbstractBlock.Settings, Block> function) {
        Block toRegister = function.apply(AbstractBlock.Settings.create().registryKey(RegistryKey.of(RegistryKeys.BLOCK, Identifier.of(PrimalCraft.MOD_ID, name))));
        registerBlockItem(name, toRegister);
        return Registry.register(Registries.BLOCK, Identifier.of(PrimalCraft.MOD_ID, name), toRegister);
    }

    private static Block registerBlockWithoutBlockItem(String name, Function<AbstractBlock.Settings, Block> function) {
        return Registry.register(Registries.BLOCK, Identifier.of(PrimalCraft.MOD_ID, name),
                function.apply(AbstractBlock.Settings.create().registryKey(RegistryKey.of(RegistryKeys.BLOCK, Identifier.of(PrimalCraft.MOD_ID, name)))));
    }

    private static void registerBlockItem(String name, Block block) {
        Registry.register(Registries.ITEM, Identifier.of(PrimalCraft.MOD_ID, name),
                new BlockItem(block, new Item.Settings().useBlockPrefixedTranslationKey()
                        .registryKey(RegistryKey.of(RegistryKeys.ITEM, Identifier.of(PrimalCraft.MOD_ID, name)))));
    }

    public static void registerModBlocks() {
        PrimalCraft.LOGGER.info("Registering Mod Blocks for " + PrimalCraft.MOD_ID);
