...
public class ModEnchantments {
    public static final RegistryKey<Enchantment> LIGHTNING_STRIKER =
            RegistryKey.of(RegistryKeys.ENCHANTMENT, Identifier.of(PrimalCraft.MOD_ID, "lightning_striker"));

    public static final RegistryKey<Enchantment> LIFESTEAL =
            RegistryKey.of(RegistryKeys.ENCHANTMENT, Identifier.of(PrimalCraft.MOD_ID, "lifesteal"));

    public static final RegistryKey<Enchantment> FROSTBITE =
            RegistryKey.of(RegistryKeys.ENCHANTMENT, Identifier.of(PrimalCraft.MOD_ID, "frostbite"));

    public static final RegistryKey<Enchantment> CHAIN_LIGHTNING =
            RegistryKey.of(RegistryKeys.ENCHANTMENT, Identifier.of(PrimalCraft.MOD_ID, "chain_lightning"));
